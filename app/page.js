  ...
  return (
    <main className="pt-5 max-w-[1366px] px-5 md:px-20 mx-auto">
      <div className="relative">
        ...
        <div className="absolute top-[35%] left-[50%] -translate-x-[50%] md:-translate-x-[0%] md:right-[5%] w-[210px] md:w-auto">
          <h1 className={`text-secondary bg-primary md:px-5 text-[20px] md:text-homeTitle ${inconsolata.className} md:mb-[-7px]`}>
            Musicalize your life
          </h1>
          <span className={`${raleway.className} text-[17px] md:text-homeSub text-primary bg-secondary md:px-5 text-center`}>
